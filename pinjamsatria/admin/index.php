  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="#" target="_blank">
        <img src="../assets/img/user.png" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold text-wrap">
          <?=
          $_SESSION['nama_user'];
          ?>
        </span>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link <?php echo ($_GET['url'] === 'dashboard') ? 'active' : ''; ?>" href="index.php?url=dashboard">
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo ($_GET['url'] === 'pinjam') ? 'active' : ''; ?>" href="index.php?url=pinjam">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-history text-secondary text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Pinjam alat & bahan</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php echo ($_GET['url'] === 'product') ? 'active' : ''; ?>" href="index.php?url=product">
            ...
            <span class="nav-link-text ms-1">Entri alat & bahan</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php echo ($_GET['url'] === 'barangmasuk') ? 'active' : ''; ?>" href="index.php?url=barangmasuk">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-calendar text-warning text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">History Masuk</span>
          </a>
        </li>
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Penyedia</h6>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php echo ($_GET['url'] === 'penyedia') ? 'active' : ''; ?>" href="index.php?url=penyedia">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-box text-danger text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">List Penyedia</span>
          </a>
        </li>
        <li class="nav-item mt-3">
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo ($_GET['url'] === 'user') ? 'active' : ''; ?>" href="index.php?url=user">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <div class="sidenav-footer mx-3 mt-4">
      <div class="card card-plain shadow-none" id="sidenavCard">
        <img class="w-50 mx-auto" src="../assets/img/profile1.png" alt="sidebar_illustration">
        <div class="card-body text-center p-3 w-100 pt-0">
          <div class="docs-info mt-2">
            <h6 class="mb-0">Role Anda : <?= $_SESSION['role']; ?></h6>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            <div class="ms-md-auto pe-md-3 d-flex align-items-center">
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="sku" id="skuInput" placeholder="Type SKU here...">
              </div>
            </div>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                <a href="https://instagram.com/sstrmdn" class="font-weight-bold" target="_blank">Muhammad Satria Rhamdani</a>
                for a better web.
              </div>
            </div>
          </div>
